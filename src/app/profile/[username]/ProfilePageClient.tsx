...
interface ProfilePageClientProps {
  ...
  likedPosts: Posts;
  isFollowing: boolean;
  followers: Follower[number];
  following: Follower[number];
    ...
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                      ...
                      >
                        <div className="font-semibold">
                          {user._count.following.toLocaleString()} <br />
                        </div>
        ...
        <Tabs defaultValue="posts" className="w-full">
          <TabsList className="w-full justify-between items-center border-b rounded-none h-auto p-0 bg-transparent">
        ...
        <Dialog
          open={showFollowerFollowing}
          onOpenChange={setShowFollowerFollowing}
        >
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle>
            ...
            <Tabs value={activeTab} className="w-full">
              ...
              <TabsContent value={activeTab} className="mt-6">
                <div className="space-y-6">
                  {followingOrFollower.length > 0 ? (
                    followingOrFollower.map((otherUser, index: number) => (
                      <motion.div
